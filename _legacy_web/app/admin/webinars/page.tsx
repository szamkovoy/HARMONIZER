        ...
        {webinars?.map((webinar) => {
          ...
          return (
            <Link
              ...
              className="rounded-2xl border border-zinc-200 bg-white p-4 transition-colors hover:border-emerald-400/30"
            >
                ...
                {recordingPublished ? (
                  ...
                  <span
                    className={`rounded-full px-2 py-0.5 ${
                      webinar.is_published ? "bg-emerald-50 text-emerald-700" : "bg-zinc-100 text-zinc-400"
                    }`}
                  >
