...
const PREPARATION_MARKERS_RU = ["я готов", "я готова", "хочу попробовать", "что мне сделать", "как мне начать", "я решила", "я решил", "я хочу", "давай попробуем", "что нужно сделать", "пора", "сейчас", "прямо сейчас"];
