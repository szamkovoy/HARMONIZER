...
| `audio` | `02_modules/audio/` | `modules/mandala-sound/core/engine.ts`; `modules/mandala-sound/core/timeline.ts`; `modules/mandala-sound/ui/MandalaSoundProvider.tsx` | `infra`, `biofeedback` | `practices`, `bindu` |
