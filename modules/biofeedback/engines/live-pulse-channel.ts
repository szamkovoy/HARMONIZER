 ...
 *    `LIVE_PULSE_EXTRAPOLATION_MAX_MS` канал выдаёт **экстраполированные** тики
 *    с периодом последнего стабильного RR.
 *  - После `LIVE_PULSE_EXTRAPOLATION_MAX_MS` без реальных ударов — событие `heartbeatLost` (флаг `lost: true` на следующем push).
