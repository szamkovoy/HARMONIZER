-- Cursor pagination for mobile video feed (social-style infinite scroll).
-- Optional p_locale filters to posts authored for that UI locale so pages stay dense.
