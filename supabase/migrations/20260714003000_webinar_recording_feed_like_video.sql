-- Published webinar recordings appear in the Videos feed / home LatestPostBanner
-- like ordinary video posts (unified post object). Live join_url remains gated
-- by webinar_registrations + webinar_community on the announce screen.
...
comment on column public.posts.webinar_id is
  'Set when kind=webinar_recording; published recordings are visible in feed like videos.';
