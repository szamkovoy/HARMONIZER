-- dialog_system_v3 v5 — owner-approved final text; activate v5, deactivate other versions.
...
$PROMPT$,
  ...
  1800,
  'text',
  'v5 ACTIVATED: owner-approved final text, two-phase branch-aware dialog. v4 deactivated.'
)
...
-- ROLLBACK (если v5 окажется хуже v4):
-- UPDATE public.prompts SET is_active = false WHERE prompt_key = 'dialog_system_v3' AND version = 5;
-- UPDATE public.prompts SET is_active = true WHERE prompt_key = 'dialog_system_v3' AND version = 4;
