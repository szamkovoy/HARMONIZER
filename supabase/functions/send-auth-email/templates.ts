...
export const TEMPLATES: Record<string, EmailTemplate> = {
  ru: {
    ...
    postVerifyGuide: 'Через минуту после подтверждения кода вновь проверьте почту — я пришлю вам подробную инструкцию к Гармонизатору. Она поможет вам разобраться в приложении.',
    closing: 'Всех благ!',
  },
  en: {
    ...
    postVerifyGuide: 'A minute after confirming the code, check your email again — I\'ll send you a detailed guide to the Harmonizer. It will help you get oriented in the app.',
  ...
  de: {
    ...
    postVerifyGuide: 'Eine Minute nach der Code-Bestätigung prüfen Sie bitte erneut Ihr E-Mail-Postfach – ich schicke Ihnen dann eine ausführliche Anleitung zum Harmonisierer. Sie hilft Ihnen, sich in der App zurechtzufinden.',
    closing: 'Alles Gute!',
  },
  fr: {
    ...
    postVerifyGuide: 'Une minute après avoir confirmé le code, consultez à nouveau votre messagerie : je vous enverrai un guide détaillé de l\'Harmoniseur. Il vous aidera à prendre en main l\'application.',
    closing: 'Bien à vous !',
  },
  it: {
    ...
    postVerifyGuide: 'Un minuto dopo aver confermato il codice, controlla di nuovo la posta: ti invierò le istruzioni dettagliate per l\'Armonizzatore. Ti aiuteranno a familiarizzare con l\'app.',
  ...
  es: {
    ...
    postVerifyGuide: 'Un minuto después de confirmar el código, revisa de nuevo tu correo: te enviaré una guía detallada del Armonizador. Te ayudará a orientarte en la aplicación.',
  ...
  pt: {
    ...
    postVerifyGuide: 'Um minuto após confirmar o código, verifique novamente seu e-mail — vou enviar para você instruções detalhadas sobre o Harmonizador. Elas vão ajudar você a se orientar no aplicativo.',
    closing: 'Tudo de bom!',
  },
  nl: {
    ...
    postVerifyGuide: 'Een minuut nadat je de code hebt bevestigd, check je e-mail opnieuw — ik stuur je een uitgebreide handleiding voor de Harmoniseerder. Die helpt je wegwijs te worden in de app.',
