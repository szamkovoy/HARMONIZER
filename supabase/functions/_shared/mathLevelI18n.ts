/** Edge copy — keep in sync with `_legacy_web/app/api/_utils/mathLevelI18n.ts`. */
import type { AppContentLocale } from "./contentLocales.ts";
...
const en: MathLevelStrings = {
  ...
  importanceLine: (planet, activation, sEff, importance) =>
    `- **${planet}**: Importance=${activation} × (0.5 + 0.5 × ${sEff}) = **${importance}**`,
  section4Title: "\n### 4. Planet of the day",
